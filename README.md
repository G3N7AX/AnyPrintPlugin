...
- PrintLog
  ...
  - The only requirement with this blueprint when customizing it for yourself is that you need an Editor Utility Scrollbox named LogScrollBox and an EditableTextBox named TextSizeInput

- BP_APP_Base, BP_APP_Editor, BP_APP_Location, BP_APP_Rotation
  - These Blueprints showcase different ways that AnyPrint can be used.

  - They print while in the editor, print the location of the actor, and print the rotation of the actor, respectively.
